...
Decimal.config({toExpNeg: -(Currency.Agate.precision + 1)});
    ...
    angular
        ...
        .service('validateService', function () {
            ...
            self.validateAssetIssue = function (issue) {
                ...
                if (issue.fee.currency !== Currency.Agate) {
                    throw new Error('Transaction fee must be nominated in Agate');
                }
            };
            ...
            self.validateAssetReissue = function (reissue) {
                if (reissue.totalTokens.currency === Currency.Agate) {
                    throw new Error('Reissuing Agate is not allowed.');
                }
                ...
                if (reissue.fee.currency !== Currency.Agate) {
                    throw new Error('Transaction fee must be nominated in Agate');
                }
            };
        });
